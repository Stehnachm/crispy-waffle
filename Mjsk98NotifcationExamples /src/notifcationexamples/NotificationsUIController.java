...
public class NotificationsUIController implements Initializable, Notifiable {
    ...
    @FXML
    private TextArea textStatusArea;
    ...
    public void displayStatus(ActionEvent event) {
        if (task1 != null) {
            notifyState("State of Task 1: " + task1.getTaskState());
        } else notifyState("Task 1 has not been started.");
        if (task2 != null) {
            notifyState("State of Task 2: " + task2.getTaskState());
        } else notifyState("Task 2 has not been started");
        if (task3 != null) {
            notifyState("State of Task 3: " + task3.getTaskState());
        } else notifyState("Task 3 has not been started");        
    }
    ...
    public void notifyState(String message) {
        ...
        textStatusArea.appendText(message + "\n");
    }
